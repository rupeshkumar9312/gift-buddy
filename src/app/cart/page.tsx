                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center gap-4">
                        ...
                        <Link href={`/product/${product.slug}`} className="text-sm font-medium hover:text-primary">
                          {product.name}
                        </Link>
                      </div>
                      ...
                      <span className="text-sm font-medium text-ink">${(price * quantity).toFixed(2)}</span>
                      <button
